...
import com.fatcat.coursetable.adapter.XndAdapter;
...
public class ChooseXndActivity extends BaseActivity {
    ...
    public void initView() {
        setContentView(R.layout.activity_choose_xnd);
    }
    ...
    protected void initData() {
        ...
        mXndListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                PrefUtils.setCurrXnd(ChooseXndActivity.this,xnd);
                PrefUtils.setCurrXqd(ChooseXndActivity.this,xqd);
    ...
    private void updateList(){
        ...
        Gson gson=new Gson();
        String[] xnds= gson.fromJson(PrefUtils.getXndInfo(this,""),String[].class);
        ...
        String xnd=PrefUtils.getCurrXnd(ChooseXndActivity.this,null);
        String xqd=PrefUtils.getCurrXqd(ChooseXndActivity.this,null);
        mXndAdapter.setCurrXnd(xnd);
        mXndAdapter.setCurrXqd(xqd);
